...
class Ui(QWidget):
    ...
    def taramaYapF(self):
        ...
        try:
            winsound.PlaySound("qr.wav", winsound.SND_FILENAME)
        except:
            pass
        ...
        while self.getShow() and qrstart:
            ...
            for qrcodee in decode(self.image):
                ...
                try:
                    ...
                    self.mfg_print_and_show('Hata Algılandı. Yeniden Başlatın.')
    ...
    def uiMailGonderFonksiyon(self):
        ...
        self.taramaYap.setEnabled(False)
        try:
            self.mfg_print_and_show('Mail göndermeye hazırlanıyor...')
            ...
            if os.path.isfile(tutanakdosyasi2):
                ...
                self.mfg_print_and_show('Gönderilecek Dosya Bulundu. Mail Oluşturuyorum...')
                mail_server = smtplib.SMTP_SSL('smtp.gmail.com', 465)
                mail_server.login("developed.caftelle@gmail.com", 'hycpvtafyhfkrjwe')
                ...
                mail_server.quit()
                try:
                    winsound.PlaySound("mailgonder.wav", winsound.SND_FILENAME)
                except:
                    pass
